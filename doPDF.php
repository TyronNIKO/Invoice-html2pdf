                ...
                <div class="table">
                    ...
                    <?php foreach ($invoice['rows'] as $row) { ?>
                        <div class="row table-row">
                            ...
                            <div class="desc"><textarea data-area="1" class="rowDescription"><?php echo $row[1]; ?></textarea></div>
                            <div class="price"><span class="curency"></span><input type="number" class="rowPrice" value="<?php echo $row[2]; ?>"></div>
                        </div>
                    <?php } ?>
                </div>
            </div>
...
<div class="controls fixed">
    ...
    <button class="btn btn-primary btn-page" data-clinic="newpage">Добавить страницу</button>
    <div class="choose-currency">
        <div class="title">Выберите валюту</div>
        <div>
            <input type="radio" id="dollar_curr" name="currency" value="1"<?php echo ($invoice['currency'] == 1)?' checked="checked"':''; ?>>
            <label for="dollar_curr">Доллар $</label>
        </div>
        <div>
            <input type="radio" id="sheqel_curr" name="currency" value="2"<?php echo ($invoice['currency'] == 2)?' checked="checked"':''; ?>>
            <label for="sheqel_curr">Шекель ₪</label>
        </div>
        <div>
            <input type="radio" id="euro_curr" name="currency" value="3"<?php echo ($invoice['currency'] == 3)?' checked="checked"':''; ?>>
